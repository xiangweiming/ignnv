function res = inHull(P1,P2,tess,tol)
%Syntax:
% res = inHull(P1,P2,tess)
%
% Inputs:
%    P1 - vertices of polytope P1
%    P2 - vertices of polytope P2
%    tess (optional, recomended)  tessellation of P2

% Outputs:
%    res - indicate P1 inside P2 or not, logical 1: yes, 0: not
%    
% Author:       Main code by John D'Errico's inhull function 
%               Edited by Weiming Xiang for this project.
% Written:      02/25/2019
% Last update:  02/25/2019

%Below is the document for John D'Errico's inhull function:
%
